...
var operations = map[string]operation{
	...
	"chat.get_conversation": {
		...
		QueryParams: map[string]string{
			"chat_message_event_fields": "chat_message_event.fields",
			"max_results": "max_results",
		},
		RequiredParams: []string{
			"conversation_id",
	...
	"chat.media_upload_append": {
		Tag: "chat",
		Name: "media_upload_append",
		Method: "POST",
	...
	"chat.get_conversations": {
		...
		QueryParams: map[string]string{
			"chat_conversation_fields": "chat_conversation.fields",
	...
	"chat.media_upload_initialize": {
		Tag: "chat",
		Name: "media_upload_initialize",
		Method: "POST",
	...
	"chat.get_user_public_keys": {
		...
		QueryParams: map[string]string{
			"public_key_fields": "public_key.fields",
		},
		RequiredParams: []string{
			"id",
		},
	...
	"connections.delete_by_endpoint": {
		Tag: "connections",
	...
	"connections.get_connection_history": {
		Tag: "connections",
		...
		QueryParams: map[string]string{
			"connection_fields": "connection.fields",
			"endpoints": "endpoints",
			"max_results": "max_results",
			"status": "status",
		},
	...
	"connections.delete_by_uuids": {
		Tag: "connections",
		Name: "delete_by_uuids",
		Method: "DELETE",
		Path: "/2/connections",
		PathParams: []string{
		},
